...
const faqs: FAQ[] = [
  {
    ...
    answer:
      "Anyone is allowed to rush KTP—we gladly accept (and encourage) rushees from all disciplines, years, and majors! Our only requirement is that you have at least 3 quarters remaining as a full time student in The College.",
  },
  {
  ...
  {
    question:
      "What if I can't/didn't meet the rush requirements (one info session and one other event)?",
    answer:
      "We're more than happy to work with anybody who's interested in rushing. Please reach out to our Director of Membership, Kyle (kylew@uchicago.edu), to discuss how we can still make rushing possible for you.",
  },
  {
      ...
      <div className="container py-5">
        <div className="scroll" id="apply">
          <div className="row px-3 px-md-0">
            ...
            <img className="img-fluid" src="assets/img/rush/banner.jpeg" alt="Rush" />
            <p style={{ textAlign: "center", paddingTop: 24 }}>
              We are excited to announce our Fall 2025 Rush Cycle. Our application is now live and
              due at 11:59 PM on Thursday, October 9th. Check out our Instagram (
          ...
          <div className="scroll" id="events">
            <div className="row px-3 px-md-0">
              ...
              <p style={{ textAlign: "center" }}>
                ...
                If this isn't possible for you, reach out to one of our Co-Directors of Membership,
                Guan (<a href="mailto:guanc@uchicago.edu">guanc@uchicago.edu</a>) or Helen (
                <a href="mailto:helentian@uchicago.edu">helentian@uchicago.edu</a>).
              </p>
